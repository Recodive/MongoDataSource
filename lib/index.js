...
class MongoDataSource extends apollo_datasource_1.DataSource {
	...
	async count(query = {}, options = { ttl: this.defaultTTL }) {
		...
		const cacheKey = this.getCacheKey("count", query),
			cacheDoc = await ((_a = this.cache) === null || _a === void 0
				? void 0
				: _a.get(cacheKey));
		...
		const count = await this.antiSpam(cacheKey, async () => {
			...
			(_a = this.cache) === null || _a === void 0
				? void 0
				: _a.set(cacheKey, JSON.stringify(r), options);
			return r;
		});
		return count;
	}
	async find(
		...
		const docs = await this.antiSpam(cacheKey, async () => {
			...
			const r = await this.collection
				...
				.toArray();
			await ((_a = this.cache) === null || _a === void 0
				? void 0
				: _a.set(cacheKey, JSON.stringify(r), options));
			return r;
		});
	...
	async delete(type, fields = {}, options = {}) {
		var _a;
		return await ((_a = this.cache) === null || _a === void 0
			? void 0
			: _a.delete(this.getCacheKey(type, fields, options)));
	}
